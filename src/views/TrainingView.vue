<template>
	<div class="container-fluid training-view">
		...
		<div class="row">
			...
			<div class="col-2"></div>
			<div class="col-4">
				<TrainingPanelComponent :ongoingTraining="ongoingTraining"></TrainingPanelComponent>
			</div>
			<div class="col-1"></div>
		</div>
		<div class="row">
			...
			<div class="col-10">
				<div class="card">
					...
					<div v-for="(log, index) in logs" :key="index">
						<TrainingLog :id="log.id" :date="log.date" :active="log.active" :inactive="log.inactive"></TrainingLog>
					</div>
				</div>
			</div>
			<div class="col-1"></div>
...
export default {
	...
	methods: {
		async isOngoingTraining(){
			let that = this;
			await axios.get(that.trainingEndpoint)
			.then((res)=>{
